						...
						<div class="wrap">
							...
							<div class="login p-5 bg-dark mx-auto mw-100">
								<form action="SellerController" method="post">
									...
									<button type="submit" value="login" name="action" class="btn btn-primary submit mb-4" >Login</button>
                ...
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <h6><%=p.getPprice() %></h6><h6 class="text-muted ml-2"></h6>
                        </div>
                    </div>
                    <div class="card-footer d-flex justify-content-between bg-light border">
                        <a href="single-product.jsp?id=<%=p.getPid()%>" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
